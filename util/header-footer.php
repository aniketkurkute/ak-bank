    ...
    function flashMessage()
{
  ...
  unset($_SESSION['success']);
    ...
    function navbar($st) {
        echo('<div class="w3-bar w3-xlarge sk-theme-navlink w3-border-bottom" style="background-color: #00EEEE;">');
        if ($st==1){echo('<a href="./index.php" class="w3-bar-item w3-button w3-blue"><b>Home</b></a>');}
            else {echo('<a href="./index.php" class="w3-bar-item w3-button "><b>Home</b></a>');}
        if ($st==2){echo('<a href="./CreateUser.php" class="w3-bar-item w3-button w3-hide-small w3-blue"><b>Create User</b></a>');}
            else {echo('<a href="./CreateUser.php" class="w3-bar-item w3-button w3-hide-small"><b>Create User</b></a>');}
        if ($st==3){echo('<a href="./TransferMoney.php" class="w3-bar-item w3-button w3-hide-small w3-blue"><b>Transfer Money</b></a>');}
            else {echo('<a href="./TransferMoney.php" class="w3-bar-item w3-button w3-hide-small"><b>Transfer Money</b></a>');}
        if ($st==4){echo('<a href="./TransactionHistory.php" class="w3-bar-item w3-button w3-hide-small w3-blue"><b>Transaction History</b></a>');}
    ...
    function foot() {
        ...
        echo('<div class=" sk-theme-navlink" style="background-color: #00EEEE; border-color:#00EEEE">
                <footer class="w3-container w3-center w3-round-small w3-border-top">
                    <p>&copy 2021. Made by <b>Aniket Kurkute</b><br>For GRIP APRIL-2021 The Sparks Foundation.</p>
                </footer>
            </div>
